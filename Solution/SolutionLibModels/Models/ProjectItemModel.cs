namespace SolutionModelsLib.Models
{
    ...
    {
        #region constructors
        public ProjectItemModel(IItemChildrenModel parent, string displayName,bool isChecked)
            : base(parent, displayName, Enums.SolutionModelItemType.Project,isChecked)
        {
        }

        internal ProjectItemModel()
            : base(null, string.Empty, Enums.SolutionModelItemType.Project,false)
        {
        ...
        void IXmlSerializable.ReadXml(XmlReader reader)
        {
            ...
            bool.TryParse(reader.GetAttribute("isChecked"),out isCheckedValue);
