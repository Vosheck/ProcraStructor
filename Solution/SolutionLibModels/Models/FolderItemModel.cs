...
namespace SolutionModelsLib.Models
{
    ...
    internal class FolderItemModel : ItemChildrenModel, IFolderItemModel
    {
        ...
        public FolderItemModel(IItemModel parent, string displayName,bool isChecked)
            : base(parent, displayName, Enums.SolutionModelItemType.Folder,isChecked)
        {
        }
        ...
        internal FolderItemModel()
            : base(null, string.Empty, Enums.SolutionModelItemType.Folder,false)
        {
        ...
        void IXmlSerializable.ReadXml(XmlReader reader)
        {
            try
            {
                ...
                string parsedCheckText = reader.GetAttribute("isChecked");
                bool? isCheckedValue=false;
                if (string.IsNullOrEmpty(parsedCheckText))
                    isCheckedValue = null;
                else isCheckedValue= Convert.ToBoolean(parsedCheckText);
        ...
        void IXmlSerializable.WriteXml(XmlWriter writer)
        {
            ...
            writer.WriteAttributeString("isChecked",this.IsChecked.ToString());
