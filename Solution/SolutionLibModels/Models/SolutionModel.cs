namespace SolutionModelsLib.Models
{
    ...
    internal class SolutionModel : ISolutionModel
    {
                                 ...
                                 , IItemChildrenModel parent)
        {
            ...
            switch (type)
            {
                case SolutionModelItemType.File:
                    newItem = new FileItemModel(parent, displayName,false);
                    break;
                case SolutionModelItemType.Folder:
                    newItem = new FolderItemModel(parent, displayName,false);
                    break;
                case SolutionModelItemType.Project:
                    newItem = new ProjectItemModel(parent, displayName,false);
                    break;
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public IItemChildrenModel AddSolutionRootItem(string displayName, long id = -1,bool? isChecked=false)
        {
            Root = new SolutionRootItemModel(displayName) { Id = id,IsChecked = isChecked};
