namespace SolutionModelsLib.Models
{
    ...
    internal class FileItemModel : ItemModel, IFileItemModel
    {
        ...
        public FileItemModel(IItemModel parent, string displayName,bool isChecked)
            : base(parent, displayName, Enums.SolutionModelItemType.File,isChecked)
        {
        }
        ...
        internal FileItemModel()
            : base(null, string.Empty, Enums.SolutionModelItemType.File,false)
        {
